...
class _ChangeGoalScreenView extends StatefulWidget {
  const _ChangeGoalScreenView({
  ...
  @override
  State<_ChangeGoalScreenView> createState() => _ChangeGoalScreenViewState();
}

class _ChangeGoalScreenViewState extends State<_ChangeGoalScreenView> {
